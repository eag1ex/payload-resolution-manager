...
* `itemFormated(data[...], uid)` : for some reason you want to make sure your data is correct and return clean unformated state. Provide data[...] in same size as initialized with `setupData`, provide that uid, and return it.
